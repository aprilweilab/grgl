...
GRGL_BGEN=1 /opt/python/cp38-cp38/bin/python setup.py bdist_wheel
echo "Building for Python 3.9"
GRGL_BGEN=1 /opt/python/cp39-cp39/bin/python setup.py bdist_wheel
echo "Building for Python 3.10"
GRGL_BGEN=1 /opt/python/cp310-cp310/bin/python setup.py bdist_wheel
echo "Building for Python 3.11"
GRGL_BGEN=1 /opt/python/cp311-cp311/bin/python setup.py bdist_wheel
echo "Building for Python 3.12"
/opt/python/cp312-cp312/bin/pip install setuptools
GRGL_BGEN=1 /opt/python/cp312-cp312/bin/python setup.py bdist_wheel
echo "Building for Python 3.13"
/opt/python/cp313-cp313/bin/pip install setuptools
GRGL_BGEN=1 /opt/python/cp313-cp313/bin/python setup.py bdist_wheel
